	...
	public static function list_items() {
        ...
        <table class="grid itemgrid">
			...
			while ( $loop->have_items() ) {
				...
				?>
                <tr data-id="<?php echo $wpinventory_item->inventory_id; ?>">
					<?php
...
//		self::update_reg_key( $settings );
            ...
            <table class="form-table">
                ...
                <tr class="reserve reserve_form_title">
                    ...
                    <td><input type="text" name="reserve_form_title" class="medium-text"
                               value="<?php echo $settings['reserve_form_title']; ?>"></td>
                </tr>
                <tr class="reserve">
	 ...
	 * @return string
	 */
	public static function grid_columns( $columns, $self, $default = 'name', $action = FALSE, $hash = '' ) {
		if ( ! self::$sortby ) {
			self::$sortby = $default;
		}
