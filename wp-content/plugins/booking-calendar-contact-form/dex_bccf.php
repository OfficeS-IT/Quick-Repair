...
function dex_bccf_gutenberg_block() {
    wp_enqueue_script( 'cpbccf_gutenberg_editor', plugins_url('/js/block.js', __FILE__));
}
...
function dex_bccf_customAdjustmentsLink($links) {
    $customAdjustments_link = '<a href="https://bccf.dwbooster.com/download">'.__('Upgrade','bccf').'</a>';
...
function set_dex_bccf_insert_adminScripts($hook) {
    if (isset($_GET["page"]) && $_GET["page"] == "dex_bccf.php")
    {
        ...
        if (isset($_GET["cal"]) && !isset($_GET["pwizard"]) && !isset($_GET["item"]))
        {
            if (!isset($_GET["list"]))
                ...
                wp_enqueue_script( 'dex_bccf_builder_script', plugins_url('/js/fbuilder.jquery.js', __FILE__),array("jquery","jquery-ui-core","jquery-ui-sortable","jquery-ui-tabs","jquery-ui-dialog","jquery-ui-droppable","jquery-ui-button","jquery-ui-datepicker","query-stringify","cp_contactformpp_rcalendar") );
        }
...
function dex_bccf_save_options()
{
    ...
    $data = array(
         ...
         'calendar_defrcolor' => @$_POST["calendar_defrcolor"],
         'calendar_deselcolor' => @$_POST["calendar_deselcolor"],         
...
function dex_bccf_data_management_loaded() 
{
    ...
    if ($_POST['dex_bccf_id']) $item = $_POST['dex_bccf_id'];
