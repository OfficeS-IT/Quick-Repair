    ...
    function insert_public_item() {
        ...
        <script type="text/javascript">
         ...
         function <?php echo $this->prefix; ?>_pform_doValidate<?php echo '_'.$this->print_counter; ?>(form)
         {
            ...
            $dexQuery = jQuery.noConflict();<?php if ($this->get_option('cv_enable_captcha', CP_APPBOOK_DEFAULT_cv_enable_captcha) != 'false') { ?>
   ...
   function data_management_loaded() {
    ...
    function data_management() {
        ...
        if (
               ...
               (
                   ($this->get_option('cv_enable_captcha', CP_APPBOOK_DEFAULT_cv_enable_captcha) != 'false') &&
